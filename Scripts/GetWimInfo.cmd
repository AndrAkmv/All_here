...
:editions
cls
dism /English /LogLevel:1 /%_img% /Get-CurrentEdition
echo -------------------------------------------------------------------------------
dism /English /LogLevel:1 /%_img% /Get-TargetEditions
echo -------------------------------------------------------------------------------
...
:languages
cls
dism /English /LogLevel:1 /%_img% /Get-Intl
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
:drivers
cls
dism /English /LogLevel:1 /%_img% /Get-Drivers /All | more
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
dism /English /LogLevel:1 /%_img% /Get-Drivers /All /Format:Table > drivers%_numd%.txt
goto :adv_menu

:packages
cls
dism /English /LogLevel:1 /%_img% /Get-Packages | more
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
dism /English /LogLevel:1 /%_img% /Get-Packages /Format:Table > packages%_nump%.txt
goto :adv_menu

:features
cls
dism /English /LogLevel:1 /%_img% /Get-Features | more
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
dism /English /LogLevel:1 /%_img% /Get-Features /Format:Table > features%_numf%.txt
goto :adv_menu

:capabils
cls
dism /English /LogLevel:1 /%_img% /Get-Capabilities /LimitAccess | more
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
dism /English /LogLevel:1 /%_img% /Get-Capabilities /LimitAccess /Format:Table > capabils%_numc%.txt
goto :adv_menu

:associat
cls
dism /English /LogLevel:1 /%_img% /Get-DefaultAppAssociations | more
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
dism /English /LogLevel:1 /%_img% /Get-DefaultAppAssociations > associat%_nums%.txt
goto :adv_menu

:appxes
cls
dism /English /LogLevel:1 /%_img% /Get-ProvisionedAppxPackages | more
echo -------------------------------------------------------------------------------
choice /c b /n /m "Back [b] "
goto :adv_menu
...
dism /English /LogLevel:1 /%_img% /Get-ProvisionedAppxPackages > appxes%_numx%.txt
goto :adv_menu
