...
schtasks /Delete /tn "\Microsoft\Windows\AppID\EDP Policy Manager" /f                                         &rem - - B C d
...
schtasks /Delete /tn "\Microsoft\Windows\AppxDeploymentClient\Pre-staged app cleanup" /f                      &rem - 9 B C d
...
schtasks /Delete /tn "\Microsoft\Windows\BitLocker\BitLocker Encrypt All Drives" /f                           &rem - - - C d
schtasks /Delete /tn "\Microsoft\Windows\BitLocker\BitLocker MDM policy Refresh" /f                           &rem - - - C d

schtasks /Delete /tn "\Microsoft\Windows\CertificateServicesClient\AikCertEnrollTask" /f                      &rem ? ? ? ? D
schtasks /Delete /tn "\Microsoft\Windows\CertificateServicesClient\KeyPreGenTask" /f                          &rem ? ? ? ? D
...
schtasks /Delete /tn "\Microsoft\Windows\Customer Experience Improvement Program\UsbCeip" /f                  &rem 7 9 B C d
...
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\HandleCommand" /f                              &rem - - B C d
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\HandleWnsCommand" /f                           &rem - - B C d
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\IntegrityCheck" /f                             &rem - - B C D
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\LocateCommandUserSession" /f                   &rem - - B C d
...
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceLocationRightsChange" /f         &rem - - B C d
...
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\RegisterDevicePolicyChange" /f                 &rem - - B C D
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceProtectionStateChanged" /f       &rem - - - C d
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceScreenOnOff" /f                  &rem - - B C -
schtasks /Delete /tn "\Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceSettingChange" /f                &rem - - B C D
...
schtasks /Delete /tn "\Microsoft\Windows\DUSM\dusmtask" /f                                                    &rem - - B C d

schtasks /Delete /tn "\Microsoft\Windows\EDP\EDP App Launch Task" /f                                          &rem - - B C d
schtasks /Delete /tn "\Microsoft\Windows\EDP\EDP Auth Task" /f                                                &rem - - B C d
schtasks /Delete /tn "\Microsoft\Windows\EDP\EDP Inaccessible Credentials Task" /f                            &rem - - - C d
schtasks /Delete /tn "\Microsoft\Windows\EDP\StorageCardEncryption Task" /f                                   &rem - - - C d
...
schtasks /Delete /tn "\Microsoft\Windows\FileHistory\File History (maintenance mode)" /f                      &rem - 9 - - -
...
schtasks /Delete /tn "\Microsoft\Windows\InstallService\ScanForUpdatesAsUser" /f                              &rem ? ? ? ? d
schtasks /Delete /tn "\Microsoft\Windows\InstallService\SmartRetry" /f                                        &rem ? ? ? ? d
...
schtasks /Delete /tn "\Microsoft\Windows\Location\Notifications" /f                                           &rem 7 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\Location\WindowsActionDialog" /f                                     &rem - - B C d
...
schtasks /Delete /tn "\Microsoft\Windows\Maps\MapsUpdateTask" /f                                              &rem - - ? ? D
schtasks /Delete /tn "\Microsoft\Windows\MemoryDiagnostic\ProcessMemoryDiagnosticEvents" /f                   &rem - 9 ? ? D
schtasks /Delete /tn "\Microsoft\Windows\MemoryDiagnostic\RunFullMemoryDiagnostic" /f                         &rem - 9 ? ? d
schtasks /Delete /tn "\Microsoft\Windows\Mobile Broadband Accounts\MNO Metadata Parser" /f                    &rem - 9 B C d
...
schtasks /Delete /tn "\Microsoft\Windows\NetTrace\GatherNetworkInfo" /f                                       &rem 7 9 B C d

schtasks /Delete /tn "\Microsoft\Windows\PI\Secure-Boot-Update" /f                                            &rem - - - - D
schtasks /Delete /tn "\Microsoft\Windows\PI\SecureBootEncodeUEFI" /f                                          &rem - - - C -
schtasks /Delete /tn "\Microsoft\Windows\PI\Sqm-Tasks" /f                                                     &rem - 9 ? ? d
...
schtasks /Delete /tn "\Microsoft\Windows\PushToInstall\LoginCheck" /f                                         &rem ? ? ? ? D
...
schtasks /Delete /tn "\Microsoft\Windows\Ras\MobilityManager" /f                                              &rem 7 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\RecoveryEnvironment\VerifyWinRE" /f                                  &rem ? ? ? ? d
schtasks /Delete /tn "\Microsoft\Windows\Registry\RegIdleBackup" /f                                           &rem 7 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\RemoteAssistance\RemoteAssistanceTask" /f                            &rem 7 9 B C D
...
schtasks /Delete /tn "\Microsoft\Windows\SettingSync\BackupTask" /f                                           &rem - 9 - - -
...
schtasks /Delete /tn "\Microsoft\Windows\Shell\CreateObjectTask" /f                                           &rem ? ? ? ? D
schtasks /Delete /tn "\Microsoft\Windows\Shell\FamilySafetyMonitor" /f                                        &rem ? ? ? ? d
...
schtasks /Delete /tn "\Microsoft\Windows\SpacePort\SpaceAgentTask" /f                                         &rem - 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\SpacePort\SpaceManagerTask" /f                                       &rem - - B C d
...
schtasks /Delete /tn "\Microsoft\Windows\Time Synchronization\ForceSynchronizeTime" /f                        &rem - 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\Time Synchronization\SynchronizeTime" /f                             &rem 7 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\TPM\Tpm-Maintenance" /f                                              &rem ? ? ? ? D
...
schtasks /Delete /tn "\Microsoft\Windows\UpdateOrchestrator\UpdateModelTask" /f                               &rem ? ? ? ? D
schtasks /Delete /tn "\Microsoft\Windows\UpdateOrchestrator\USO_UxBroker" /f                                  &rem ? ? ? ? D

schtasks /Delete /tn "\Microsoft\Windows\WDI\ResolutionHost" /f                                               &rem ? ? ? ? D
...
schtasks /Delete /tn "\Microsoft\Windows\Windows Filtering Platform\BfeOnServiceStartTypeChange" /f           &rem 7 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\Windows Media Sharing\UpdateLibrary" /f                              &rem 7 9 B C d
schtasks /Delete /tn "\Microsoft\Windows\WindowsBackup\ConfigNotification" /f                                 &rem 7 - - - -
schtasks /Delete /tn "\Microsoft\Windows\WindowsColorSystem\Calibration Loader" /f                            &rem 7 9 B C D
